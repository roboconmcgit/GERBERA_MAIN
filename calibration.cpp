...
//*****************************************************************************
calibrationData calibration::set_calibration(){
    calibrationData ret;
//0729 kota Color Sensor Calibration
    ...
    ret.black_slant = 2;
      ...
      ev3_lcd_fill_rect(0, 0, EV3_LCD_WIDTH, EV3_LCD_HEIGHT, EV3_LCD_WHITE);
      sprintf(s,"BLACK : %2d",ret.black);
      ev3_lcd_draw_string(s, 0, CALIB_FONT_HEIGHT*1);
      sprintf(s,"WHITE : %2d",ret.white);
      ev3_lcd_draw_string(s, 0, CALIB_FONT_HEIGHT*2);
    #ifdef  RIGHT_COURCE_MODE
      sprintf(s,"BLACK_SLANT : %2d",ret.black_slant);
      ev3_lcd_draw_string(s, 0, CALIB_FONT_HEIGHT*3);
      sprintf(s,"WHITE_SLANT : %2d",ret.white_slant);
